...
pub const OPCODES: [OpCode; 256] = [
    ...
    OpCode::new(0x64, "STZ", 2, 4, AddressingMode::ZeroPage, true),
    ...
    OpCode::new(0x74, "STZ", 2, 5, AddressingMode::ZeroPage_X, true),
    ...
    OpCode::new(0x9c, "STZ", 3, 5, AddressingMode::Absolute, true),
    OpCode::new(0x9d, "STA", 3, 5, AddressingMode::Absolute_X, false),
    OpCode::new(0x9e, "STZ", 3, 6, AddressingMode::Absolute_X, true),
